    ...
    public partial class initalize : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FeatureHeaderId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    HeaderTitle = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HeaderPostDescription = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HeaderPostImage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HeaderPostStatus = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FeatureHeaders", x => x.FeatureHeaderId);
                });
